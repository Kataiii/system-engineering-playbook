...
![](./article_images/image1.jpeg){width="6.291666666666667in"
...
+---------+------------+-------------+------------------+-------------+
| Метод / | Задача | Точность | Преимущества | Недостатки |
| Модель | | (F1-Score) | | |
+=========+============+=============+==================+=============+
| XGBoost | Прогн | 0.94 | Высокая | Не подходит |
| | озирование | | точность, | для |
| | риска | | скорость работы, | временных |
| | травмы | | ин | рядов |
| | | | терпретируемость | |
+---------+------------+-------------+------------------+-------------+
| LSTM | Прогноз | 0.89 | Учет временных | Требует |
| | уровня | | зависимостей, | больших |
| | усталости | | высокая точность | данных, |
| | | | прогноза | сложнее в |
| | | | | обучении |
+---------+------------+-------------+------------------+-------------+
| Л | Прогноз | 0.72 | Простота и | Низкая |
| инейная | уровня | | скорость | точность на |
| ре | усталости | | | нелинейных |
| грессия | | | | данных |
+---------+------------+-------------+------------------+-------------+
| R | До | 0.91 (по | Способность к | Длительное |
| L-агент | лгосрочное | | адаптации и | время |
| | пл | возн | нахождению | обучения, |
| | анирование | аграждению) | нетривиальных | сложность |
| | | | стратегий | настройки |
+---------+------------+-------------+------------------+-------------+
| Экс | До | 0.78 (по | Прозрачность и | Не |
| пертная | лгосрочное | | предсказуемость | способность |
| система | пл | возн | | к |
| | анирование | аграждению) | | адаптации, |
| | | | | жесткость |
| | | | | правил |
+---------+------------+-------------+------------------+-------------+
